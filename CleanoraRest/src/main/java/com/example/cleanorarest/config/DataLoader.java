...
import com.example.cleanorarest.entity.*;
...
public class DataLoader {
    ...
    public void loadUsers() {
        ...
        defaultCustomer.setName("customer");
        defaultCustomer.setEmail("customer@gmail.com");
        defaultCustomer.setPhoneNumber("+380677777777");
        defaultCustomer.setPassword("customer");
        ...
        while (!orderService.ifOrderMoreThan(5)) {
            CustomerAddressRequest addressOrder = new CustomerAddressRequest();
            addressOrder.setCountry("Ukraine");
            addressOrder.setCity("Kyiv");
            addressOrder.setStreet("Tarasa Shevchenko");
            addressOrder.setHouseNumber("22");
            startDate = startDate.plusDays(5);
            OrderRequest orderRequest = new OrderRequest();
            orderRequest.setAddress(addressOrder);
            ...
            orderService.createOrder(orderRequest, "customer@gmail.com");
        }
